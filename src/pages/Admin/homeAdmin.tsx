...
//     datasets: [
//       {
//         label: 'Publication Percentage',
//         data: [5, 10, 7, 3, 8, 12, 15, 30, 25, 10, 9, 19], // Replace with your actual data
...
//     <>
//       <MenuSlideAdmin />
//       <IonPage id="main-content" className="homeAdmin">
//         <IonHeader>
...
//                     <IonText>
//                       <h3 className="text1" style={{ fontSize: '20px' }}>
//                         Jumlah Publikasi
//                       </h3>
//                       <p className="text11" style={{ fontSize: '20px' }}>
//                         14
//                       </p>
//                     </IonText>
//                   </IonCardContent>
...
//                     <IonText>
//                       <h3 className="text2" style={{ fontSize: '20px' }}>
//                         Jumlah Pemberitahuan
//                       </h3>
//                       <p className="text22" style={{ fontSize: '20px' }}>
//                         10
//                       </p>
//                     </IonText>
//                   </IonCardContent>
...
//                     <IonText>
//                       <h3 className="text3" style={{ fontSize: '20px' }}>
//                         Jumlah Mahasiswa Online
//                       </h3>
//                       <p className="text33" style={{ fontSize: '20px' }}>
//                         27
//                       </p>
//                     </IonText>
//                   </IonCardContent>
...
//                   <IonCardContent>
//                     <IonText>
//                       <h3 className="text4" style={{ fontSize: '25px' }}>
//                         Informasi
//                       </h3>
//                       <ol>
//                         <li style={{ fontSize: '22px' }}>
//                           Dikarenakan sistem informasi ini masih dalam proses pengembangan maka kami memohon maaf jika terdapat
//                           kekurangan nyaman anda.
//                         </li>
